...
{
    public abstract class AuditableRepositoryBase : RepositoryBase
    {
 
		public AuditableRepositoryBase (IAppUser userInfo, DbContext dbContext) : base (userInfo, dbContext)
		{
		}
